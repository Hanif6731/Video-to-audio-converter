...
namespace VideoConverter
{
    ...
    public partial class ConvertFromFolder : MetroForm
    {
        ...
        private void BtnBrowse_Click(object sender, EventArgs e)
        {
            ...
            {
                this.txtVideo.Text = fbd.SelectedPath;
        ...
        private void ConvertFromFolder_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
